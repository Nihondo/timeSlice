...
6. [設定ガイド](#設定ガイド)
   ...
   - [アップデートタブ](#アップデートタブ)
7. [自動アップデート](#自動アップデート)
8. [ビューアウィンドウ](#ビューアウィンドウ)
9. [データの保存先](#データの保存先)
10. [権限の設定](#権限の設定)
11. [トラブルシューティング](#トラブルシューティング)
12. [ソースからビルド](#ソースからビルド)
...
| **アップデートを確認...** | Sparkle を使って新しいバージョンを確認します |
...
Sparkle による自動アップデートを管理します。

- 現在のアプリバージョンと最終チェック日時を表示します。
- 「今すぐ確認」で手動アップデートチェックを開始します。
- 「自動でアップデートを確認する」で、起動時および定期バックグラウンドチェックの有効状態を切り替えます。
- 「すべてのリリースを表示」から GitHub Releases ページを開けます。

---

## 自動アップデート

timeSlice は [Sparkle](https://sparkle-project.org/) を使用した自動アップデートに対応しています。
